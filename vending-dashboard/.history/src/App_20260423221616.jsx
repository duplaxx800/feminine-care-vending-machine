...
const MOCK_INVENTORY = {
  slot1: { name: "Napkin with wings", price: 5, stock: 2, capacity: 10 },
  slot2: { name: "Napkin without wings", price: 10, stock: 7, capacity: 10 },
  slot3: { name: "Napkin Long Pad", price: 5, stock: 4, capacity: 15 },
  slot4: { name: "Wet wipes", price: 5, stock: 1, capacity: 12 },
};
